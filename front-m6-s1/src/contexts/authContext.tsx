...
import { IUserLogin, IProviderProps, IUserRegister, IUserContact } from "@/types"
...
export const AuthProvider = ({children}: IProviderProps) => {
    ...
    const createContact = async (userData: FieldValues) => {
        api.post("/api/user/contact", userData)
        .then(async (response) => {
            toast({
                title: 'sucess',
                variant: 'solid',
    ...
    return (
        <AuthContext.Provider value={{login, registerModal, deleteContact, isLoged, createContact, contacts, setContacts}}>
            {children}
